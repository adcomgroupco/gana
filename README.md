...
Reconstrucción semana a semana (S17 a S31) de las acciones de pauta de Placa Millonaria y las líneas asociadas, con foco en cambios de presupuesto y priorización de formatos.

| Canal | Cuenta | Ventana | Inversión |
|---|---|---|---|
| Meta | CP_GANA (`act_1078955982538777`) | 20 abr — 29 may | $63.398.845 |
...
Los $63,4 M corresponden a toda la cuenta CP_GANA en el período (22 campañas: registros, compra, GanaApp, legalidad y Placa Millonaria). La línea Placa Millonaria por sí sola suma $10,9 M. Programática y DOOH corresponden únicamente a Placa Millonaria.
